          ...
          {players.map((player) => (
            ...
            >
              ...
              <div className="flex-1">
               ...
               <Badge variant={player.status === 'active' ? 'default' : 'destructive'} className="capitalize">
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuSeparator />
                   {player.status === 'active' ? (
                     <DropdownMenuItem className="text-destructive focus:bg-destructive/10 focus:text-destructive">Suspender</DropdownMenuItem>
                   ) : (
